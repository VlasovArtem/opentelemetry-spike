...
// LogRecordsPartialSuccessError returns an error describing a partial success
// response for the trace signal.
func LogRecordsPartialSuccessError(itemsRejected int64, errorMessage string) error {
	return PartialSuccess{
		ErrorMessage:  errorMessage,
		RejectedItems: itemsRejected,
		RejectedKind:  "log records",
	}
}
